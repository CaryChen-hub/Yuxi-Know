...
相关研究表示Prompt的开头和结尾的词对结果影响比较大，更敏感。
"""

output_template = """
感谢您使用伏羲盐碱地智能算法决策系统，根据您提供的盐碱地现有条件和期望目标，结合当地三十年的盐碱地治理经验与AI人工智能算法思考，系统将按照：
1. 归需求
2. 深剖析
3. 提思路
4. 呈方案
5. 长展望
的逻辑给您提供盐碱地的分析和决策具体方案。详细结果如下：
我在五原试验点投入100万治理盐碱地，想种植向日葵
请你分点回答以下几个问题：
1. 我的需求是什么
2. 该验证点盐碱地的形成原因是什么（请从气候、土壤理化性质、成因等方面回答）
3. 该地盐碱地的治理思路是什么
4. 该地盐碱地的具体治理方案是什么（请具体描述实施方案）
5. 经过治理后该地的适合作物、治理时间、产量预估
"""
